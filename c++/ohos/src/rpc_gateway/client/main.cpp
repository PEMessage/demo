...
int main()
{
    ...
    // 7. Unregister callback before exit
    HiLogInfo(CLIENT_LABEL, "[Client] Unregistering callback...");
    gatewayProxy->UnregisterClientCallback(clientCallback);

    HiLogInfo(CLIENT_LABEL, "[Client] Client stopped");
    return 0;
}
