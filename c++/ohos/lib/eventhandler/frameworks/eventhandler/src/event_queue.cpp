...
// PEM Modify: void EventQueue::HandleFileDescriptorEvent(int32_t fileDescriptor, uint32_t events,   // error: attributes are not allowed on a function-definition
// PEM Modify:   const std::string &taskName, Priority priority) __attribute__((no_sanitize("cfi")))
void EventQueue::HandleFileDescriptorEvent(int32_t fileDescriptor, uint32_t events,
    const std::string &taskName, Priority priority)
{
