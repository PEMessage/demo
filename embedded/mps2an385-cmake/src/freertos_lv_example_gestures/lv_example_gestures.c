 ...
 *      INCLUDES
 *********************/
// #include "../../lv_examples.h"  PEM Modify
// #if LV_USE_GESTURE_RECOGNITION && LV_BUILD_EXAMPLES // PEM Modify
#include "lvgl.h" // PEM Modify
...
// #endif /* LV_USE_GESTURE_RECOGNITION && LV_USE_FLOAT */ PEM Modify
