...
class JavaMapClassTemplate(Template):
    ...
    def add_arguments(cls, subparser):
        ...
        subparser.add_argument('--gentype',
                               default='java',
                               choices=['java', 'cpp-swap'],
    ...
    @classmethod
    def generate(cls, args):
        if args.gentype == "java":
            return cls.java_generate(args)
        elif args.gentype == "cpp-swap":
            pass

    @classmethod
    def cpp_swap_generate(cls, args):
        class_name = args.class_name
        fields = args.fields
        pass

    @classmethod
    def java_generate(cls, args):
